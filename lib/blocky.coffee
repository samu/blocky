...
# keywords = ["begin", "if", "while"]
#
# blockStartRegexes = {}
# for keyword in keywords
#   blockStartRegexes[keyword] = new RegExp("^#{keyword}\s|\s#{keyword}\s", 'g')
...
module.exports = Blocky =
  ...
  activate: (state) ->
    ...
    atom.workspace.observeTextEditors (editor) ->
      ...
      # keywords = jQuery(html).find(".keyword")
      # for keyword in keywords
...
class Aighlights
  ...
  _highlightCommon: ({filePath, fileContents, scopeName}={}) ->
    ...
    console.log grammar.tokenizeLine("class Abc").tags
